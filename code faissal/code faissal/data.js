...
"use strict"
const timeDelay = 5000; // time delay refresh data
...
async function renderData() {
  ...
  dataDiv.innerHTML = `<h3>Datum: ${datum.toLocaleString()}</h3><p> vochtigheid ${measurement.value2} temperatuur ${measurement.value1} </p>` 
